...
public class PriorityInterstitialController {
    ...
    private static void showGoogleFirst(Activity activity,
        ...
        GoogleInterstitialAdHelper.show(activity, new GoogleInterstitialAdHelper.Callback() {
    ...
    private static void showFacebookFirst(Activity activity,
        ...
        FacebookInterstitialHelper.show(activity, new FacebookInterstitialHelper.Callback() {
    ...
    private static void preloadNext(Activity activity, AdsConfig config) {
        GoogleInterstitialAdHelper.preload(activity, config);
        FacebookInterstitialHelper.preload(activity, config);
    }
}
